...
SECRET_KEY = 'django-insecure-6&5$9l@g8v(6p=c(64be-f*i_n2if7=6bf9l*=t(qi36lv#64d'
...
# 영화 api 가져오기
config_secret_debug = json.loads(open('secret.json').read())
TMDB_API = config_secret_debug['TMDB_API']
