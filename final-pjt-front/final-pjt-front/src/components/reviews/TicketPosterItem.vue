  ...
  <div class="ticket-wrapper">
    ...
    <svg class="ticket-shape" width="95%" xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
            ...
            <g xmlns="http://www.w3.org/2000/svg" width="100%" transform="translate(0,1200) scale(0.1,-0.1)" fill="#FFF">
         ...
         <image width="100%" height="100%" :xlink:href="'https://image.tmdb.org/t/p/original'+movie.thumbnail" clip-path="url(#myCircle)" />
...
.ticket-container {
    display: inline-block;
    mask-image: url(../../assets/ticket_shape.svg);
    -webkit-mask-box-image: url(../../assets/ticket_shape.svg);
    mask-size: 100vmin;
